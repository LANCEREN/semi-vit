...
from util.datasets import build_dataset_contrast
from util.pos_embed import interpolate_pos_embed
from util.misc import NativeScalerWithGradNormCount as NativeScaler

from models import vit as models_vit

from engine_contrast import train_one_epoch
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--unautho_data_path', default='~/data/imagenet/', type=str,
                        help='dataset path')
    parser.add_argument('--autho_data_path', default='~/data/imagenet/', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--anno_percent', type=float, default=0.5, help='number of labeled data')

    parser.add_argument('--output_dir', default='/home/renge/Pycharm_Projects/semi-vit/logs/contrast-learning',
                        help='path where to save, empty for no saving')
    parser.add_argument('--comment', default='contrast-learning',
                        help='comment')
...
def main(args):
    ...
    criterion = engine_contrast.ContrastiveLoss()
